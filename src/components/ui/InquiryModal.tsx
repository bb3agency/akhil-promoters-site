    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="relative w-full max-w-lg overflow-hidden bg-white shadow-2xl rounded-2xl border border-gray-100 max-h-[calc(100dvh-2rem)] flex flex-col"
        >
          {/* Header Banner */}
          ...
          {/* Form Content */}
          <div className="p-4 sm:p-7 bg-akhil-off-white overflow-y-auto flex-1">
            {submitted ? (
              <motion.div
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white border border-akhil-border rounded-xl text-base sm:text-sm text-akhil-charcoal focus:outline-none focus:border-akhil-red resize-none"
                  />
                </div>
